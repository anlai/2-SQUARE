...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%: Html.ActionLink<GoalController>(a=>a.Add(Model.ProjectStep.Id), "Add Asset", new {@class="button ui-corner-all ui-state-default", style="float:right; margin-top: 8px;"}) %>
    ...
    <%: Html.ActionLink<GoalController>(a=>a.Add(Model.ProjectStep.Id), "Add Privacy Goal", new {@class="button ui-corner-all ui-state-default", style="float:right; margin-top: 8px;"}) %>
