/*
Deployment script for 2Square.Sql
*/
...
GO
:setvar DatabaseName "2Square.Sql"
...
CREATE DATABASE [$(DatabaseName)]
    ON 
    PRIMARY(NAME = [2Square], FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS\MSSQL\DATA\2Square.mdf', SIZE = 3328 KB, FILEGROWTH = 1024 KB)
    LOG ON (NAME = [2Square_log], FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS\MSSQL\DATA\2Square_log.ldf', SIZE = 768 KB, MAXSIZE = 2097152 MB, FILEGROWTH = 10 %) COLLATE SQL_Latin1_General_CP1_CI_AS
GO
...
GO
PRINT N'Creating PK_Goals...';


GO
ALTER TABLE [dbo].[Goals]
    ADD CONSTRAINT [PK_Goals] PRIMARY KEY CLUSTERED ([id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);
...
GO
PRINT N'Creating PK_PRETAnswerXLaws_1...';


GO
ALTER TABLE [dbo].[PRETAnswerXLaws]
    ADD CONSTRAINT [PK_PRETAnswerXLaws_1] PRIMARY KEY CLUSTERED ([AnswerId] ASC, [LawId] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);
...
GO
PRINT N'Creating [dbo].[ProjectSteps]...';
...
GO
PRINT N'Creating PK_ProjectSteps...';
...
GO
PRINT N'Creating PK_ProjectTerms...';


GO
ALTER TABLE [dbo].[ProjectTerms]
    ADD CONSTRAINT [PK_ProjectTerms] PRIMARY KEY CLUSTERED ([id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating [dbo].[ProjectWorkers]...';
...
GO
PRINT N'Creating PK_ProjectWorkers_1...';
...
GO
PRINT N'Creating [dbo].[SquareTypes]...';
...
GO
PRINT N'Creating PK_RequirementCategories...';


GO
ALTER TABLE [dbo].[SquareTypes]
...
GO
PRINT N'Creating PK_Steps...';


GO
ALTER TABLE [dbo].[Steps]
    ADD CONSTRAINT [PK_Steps] PRIMARY KEY CLUSTERED ([id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);
...
GO
PRINT N'Creating DF_Definitions_IsActive...';
...
GO
PRINT N'Creating DF_GoalTypes_IsActive...';
...
GO
PRINT N'Creating DF_ProjectSteps_Complete...';
...
GO
PRINT N'Creating FK_Goals_GoalTypes...';
...
GO
PRINT N'Creating FK_Goals_Projects...';
...
GO
PRINT N'Creating FK_Goals_SquareTypes...';
...
GO
PRINT N'Creating FK_GoalTypes_SquareTypes...';
...
GO
PRINT N'Creating FK_ProjectSteps_Projects...';


GO
ALTER TABLE [dbo].[ProjectSteps] WITH NOCHECK
...
GO
PRINT N'Creating FK_ProjectSteps_Steps...';
...
GO
PRINT N'Creating FK_ProjectTerms_Projects...';
...
GO
PRINT N'Creating FK_ProjectTerms_SquareTypes...';
...
GO
PRINT N'Creating FK_ProjectWorkers_aspnet_Roles...';
...
GO
PRINT N'Creating FK_ProjectWorkers_aspnet_Users...';
...
GO
PRINT N'Creating FK_ProjectWorkers_Projects...';
...
GO
PRINT N'Creating FK_Steps_RequirementCategories...';


GO
ALTER TABLE [dbo].[Steps] WITH NOCHECK
...
GO
PRINT N'Creating FK_Terms_SquareTypes...';


GO
ALTER TABLE [dbo].[Terms] WITH NOCHECK
...
ALTER TABLE [dbo].[Goals] WITH CHECK CHECK CONSTRAINT [FK_Goals_Projects];
...
ALTER TABLE [dbo].[ProjectSteps] WITH CHECK CHECK CONSTRAINT [FK_ProjectSteps_Steps];

ALTER TABLE [dbo].[ProjectTerms] WITH CHECK CHECK CONSTRAINT [FK_ProjectTerms_Projects];

ALTER TABLE [dbo].[ProjectTerms] WITH CHECK CHECK CONSTRAINT [FK_ProjectTerms_SquareTypes];

ALTER TABLE [dbo].[ProjectWorkers] WITH CHECK CHECK CONSTRAINT [FK_ProjectWorkers_aspnet_Roles];
...
ALTER TABLE [dbo].[Terms] WITH CHECK CHECK CONSTRAINT [FK_Terms_SquareTypes];
